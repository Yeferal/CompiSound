...
java -jar C:\Users\Usuario\Desktop\Compi2\projects\Project1\CompiSound\DesktopReproductor\libraries\java-cup-11b.jar -parser SyntaxAnalyzerList -symbols SymbolListCode SyntaxList.cup
pause